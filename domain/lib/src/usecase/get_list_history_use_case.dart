...
@Injectable()
class GetHistoryUseCase extends BaseFutureResUseCase<GetHistoryUseCaseInput, HistoryAmaiList> {
  ...
  @protected
  @override
  Future<HistoryAmaiList> buildUseCase(GetHistoryUseCaseInput input) {
