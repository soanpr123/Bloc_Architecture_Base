...
class _INTERNALAPPAPI implements INTERNALAPPAPI {
  ...
  @override
  Future<HttpResponse<dynamic>> paymentAmai(request) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  @override
  Future<AmaiHistory> amaiHistory(
    page,
    perPage,
  ) async {
    const _extra = <String, dynamic>{};
    ...
    final _data = <String, dynamic>{};
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<AmaiHistory>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
            .compose(
              _dio.options,
              'transactions/histories?page=${page}&per_page=${perPage}',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
    final value = AmaiHistory.fromJson(_result.data!);
    return value;
  }
